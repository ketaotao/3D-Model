...
import { User, Bell, Palette, Zap, CreditCard, Shield, Globe, X } from 'lucide-react';
        ...
        <div className="grid grid-cols-[280px_1fr] gap-8">
            ...
            {sections.map((section) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm" style={{ fontWeight: 500 }}>{section.label}</span>
                </button>
              );
            })}
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-8">
            ...
            {activeSection === 'performance' && (
              <div className="space-y-6">
                <h2 className="text-xl mb-6 text-foreground" style={{ fontWeight: 700 }}>성능 설정</h2>
                <div className="space-y-4">
                  <div className="p-4 bg-input-background rounded-lg border border-border">
                    <p className="text-sm mb-2 text-foreground" style={{ fontWeight: 600 }}>기본 모델 품질</p>
                    <select className="w-full px-4 py-2.5 bg-card border border-border text-foreground rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5b5bff]/50">
                      <option value="fast">빠름 (30-60초)</option>
                      <option value="standard">표준 (2-3분)</option>
                      <option value="detailed">정밀 (5-7분)</option>
                    </select>
                  </div>
                  <div className="p-4 bg-input-background rounded-lg border border-border">
                    <p className="text-sm mb-2 text-foreground" style={{ fontWeight: 600 }}>기본 해상도</p>
                    <select className="w-full px-4 py-2.5 bg-card border border-border text-foreground rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5b5bff]/50">
            ...
            {activeSection === 'billing' && (
              <div className="space-y-6">
                <h2 className="text-xl mb-6 text-foreground" style={{ fontWeight: 700 }}>결제 및 구독</h2>
                <div className="p-6 bg-gradient-to-br from-[#5b5bff]/10 to-[#6366f1]/10 rounded-xl border border-[#5b5bff]/30">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="text-sm text-muted-foreground mb-1">현재 플랜</p>
                      <p className="text-xl text-foreground" style={{ fontWeight: 700 }}>무료 플랜</p>
                    </div>
                    <button className="px-4 py-2 bg-[#5b5bff] text-white rounded-lg hover:opacity-90 transition-all text-sm" style={{ fontWeight: 600 }}>
                      업그레이드
                    </button>
                  </div>
                  <div className="space-y-2 text-sm text-foreground opacity-80">
                    <p>• 월 10회 모델 생성</p>
                    <p>• 최대 해상도 1024px</p>
                    <p>• 기본 내보내기 형식</p>
                  </div>
